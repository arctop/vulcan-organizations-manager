...
class InviteForm extends React.Component {
  ...
  handleChange(event) {
    ...
    if (isValid) {
      ...
      this.setState({ email: value, errorMessage: { field: 'email', type: 'warning', message: 'Email required'}, valid: isValid  });
    }
    else {
      this.setState({ email: value, errorMessage: { field: 'email', type: 'warning', message: "Email invalid"}, valid: isValid });
    }
  }
